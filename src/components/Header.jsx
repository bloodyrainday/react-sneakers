...
const Header = ({ onClickCart, orderedItems, countTotalPrice }) => {
      ...
      <div className="container header__container">
        ...
        <nav className="nav header__nav">
          <ul className="nav__list">
            <li className="nav__item" onClick={onClickCart}>
              <svg
                width="20"
                height="20"
                viewBox="0 0 20 20"
            ...
            <Link to="react-sneakers/orders">
              <li
                className="nav__item"
                onClick={() =>
                  console.log("orders that you made", orderedItems)
                }
              >
                <svg
                  width="18"
          ...
          <div
            className={`burger ${isBurger ? "clicked" : ""}`}
            onClick={clickBurger}
          >
            <span></span>
          </div>
